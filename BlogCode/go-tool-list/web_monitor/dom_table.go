...
func newDomTable(name string) *DomTable {
	return &DomTable{
		Name:    name,
...
// AddHeader 添加表头
func (t *DomTable) AddHeader(row ...interface{}) {
	t.Header = row
}

// AddRow 添加表行
func (t *DomTable) AddRow(row ...interface{}) {
...
// 参数1：列index，从0开始
// 参数2：是否从大到小排序
func (t *DomTable) Sort(colIndex int, desc bool) {
...
func (t *DomTable) MultSort(ids ...interface{}) {
...
func (t *DomTable) toFloat64(v interface{}) (float64, bool) {
	if v == nil {
		return 0, false
	}
	str := ""
...
func (t *DomTable) AddNo() {
	t.No = true
}

func (t *DomTable) rowHTML(index int, row []interface{}, ti string) string {
	if len(row) == 0 {
		return ""
	}
	html := "<tr>"
...
// 默认右对齐
func (t *DomTable) TextAlignLeft(cols ...int) {
...
// 默认右对齐
func (t *DomTable) TextAlignCenter(cols ...int) {
	for _, col := range cols {
...
func (t *DomTable) MaxHeight(height int) {
	t.maxHeight = height
}

func (t *DomTable) Html() string {
