...
<font face="微软雅黑" >上学的时候看C++各种书籍, 说过字符数组与string之间转换要注意处理方式的数不胜数, 没想到最终还是踩了这个坑. 这次错误的赋值直接导致了错误的删除逻辑, 在积累了一周后线上服务大面积告警, 算是一次事故了, 难受呀。 大佬们说不要有心理负担，我觉得负担还是要有，但要在将来要让这些负担转换为自己的储备才行。</font>
